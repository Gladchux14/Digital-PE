    ...
    <div className="bg-[#E1F2FD] py-8">
      <div className="max-w-5xl mx-auto py-8 px-4 ">
        ...
        <div>
          ...
          <ol
            style={{ listStyleType: "lower-alpha font-bold" }}
            className="list-inside ml-6 "
          >
            <li>
             <span  className="font-bold">SMS-based 2FA:</span> You receive a one-time code via text message.
              <ul className="list-disc list-inside">
                <li>
            ...
            <li> <span className="font-bold"> App-based 2FA (Recommended):</span> You use an authenticator app (e.g., Google Authenticator, Authy) to generate a one-time code.
            <ul className="list-disc list-inside">
                <li>
                  <span className="font-bold">Pros:</span> More secure than SMS. Codes change every 30 seconds.
                </li>
                <li>
                  <span className="font-bold">Cons:</span>Requires installing an app on your phone.
                </li>
              </ul>
            </li>

            <li>
              <span className="font-bold"> Hardware-based 2FA:</span> Uses a physical security key (e.g., YubiKey).
              <ul className="list-disc list-inside">
                <li>
                  <span className="font-bold">Pros:</span> Extremely secure.
                </li>
                <li>
                  <span className="font-bold">Cons:</span> Requires purchasing a physical device.
                </li>
              </ul>
            </li>
          </ol>
        ...
        <h2 className="my-6 font-bold">For this guide, we’ll focus on app-based 2FA, which is the most secure and widely used method.</h2>
        ...
        <div>
          ...
          <ul className="mb-6 list-disc list-inside">
            ...
            <li>
              A new page will show you if you want paid; choose your preferred
              plan and if you are going free, scroll down, till you come across
              this section shown in the image below
            </li>
            ...
            <li className="mb-6 list-disc list-inside">
              Create an account with your email address if you are going free
              and the ProtonVPN will suggest a password for you, which you can
              go for, if you want.
            </li>
        ...
        <div>
          <h3 className="mb-4 font-bold">
            2. Verify and Complete your ProtonVPN account:
          </h3>
          <ul className="mb-6 list-disc list-inside">
            <li>
        ...
        <div>
          <h3 className="mb-4 font-bold">
            3. Welcome to your ProtonVPN dashboard:
          </h3>
          <ul className="mb-6 list-disc list-inside">
            <li>
        ...
        <div>
          <h3 className="mb-4 font-bold">
            4. Connecting to the ProtonVPN App:
          </h3>
          <ul className="list-disc list-inside">
            <li>
            ...
            <li>
              On the home page, you will see a Connect button. Please click
              that, and you will be taken to your device. 
            </li>
            ...
            <li>
              Once connected, your IP address will be hidden, and your data
              encrypted.
            </li>
        ...
        <div>
          <h3 className="mb-2  mt-6 text-[#2196F3]">
          ...
          <ul className="list-disc list-inside">
            <li className="mb-1">
              Go to{" "}
              <a href="www.whatismyip.com" className="underline">
                WhatIsMyIP.com
              </a>{" "}
              before and after connecting to see if your IP address changes.
            </li>
            <li className="mb-1">
              Check for DNS Leaks using sites like{" "}
              <a href="dnsleaktest.com" className="underline">
                DNSLeakTest.com
              </a>
              .
            </li>
